pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_REPO = 'dibyadarshandevops/project4'  // Repository only
    ...
    stages {
        stage('Clone Repository') {
            steps {
                ...
                git 'https://github.com/Dibyadarshan9777/project4.git'  // Update with your repo URL
            }
        }
        ...
        stage('Deploy to Kubernetes') {
            steps {
                script {
                    ...
                    sh """
                        helm upgrade --install project4-release ./project4 \
